...
# Calculates average values for the 19 bioclimatic variables for 2000-2023, 
# based on monthly values for the 23 year span. Monthly climate data (tmin, tmax, and prec) 
...
# This script taken from Jeff Oliver and Erin Zylstra's work on swallowtails
# script names "prep-climate-data.R"
...
year_span <- 2000:2018
# Rough bounding box for western United States
